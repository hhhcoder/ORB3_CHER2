...
namespace ORB_SLAM3 {
    ...
    void Settings::readKfParam(cv::FileStorage &fSettings) {
        bool found;
        kfParam[0] = readParameter<float>(fSettings,"InsertKfSetting.para1",found);
        kfParam[1] = readParameter<float>(fSettings,"InsertKfSetting.para2",found);
        kfParam[2] = readParameter<float>(fSettings,"InsertKfSetting.para3",found);
        kfParam[3] = readParameter<float>(fSettings,"InsertKfSetting.para4",found);
        kfParam[4] = readParameter<float>(fSettings,"InsertKfSetting.para5",found);
        kfParam[5] = readParameter<float>(fSettings,"InsertKfSetting.para6",found);
        kfParam[6] = readParameter<float>(fSettings,"InsertKfSetting.para7",found);
        kfParam[7] = readParameter<float>(fSettings,"InsertKfSetting.para8",found);
        kfParam[8] = readParameter<float>(fSettings,"InsertKfSetting.para9",found);
    }
